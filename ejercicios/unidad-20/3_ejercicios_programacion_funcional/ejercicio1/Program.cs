...
namespace Ejercicio1
{
    ...
    public class Biblioteca
    {
        ...
        private const string FICHERO_PRESTAMOS = "prestamos.txt";
        ...
        {
            Func<Libro, bool> tieneISBN = libro => libro.ISBN == isbn;
            return Libros.Find(l => tieneISBN(l));
        }
        ...
        {
            return Prestamos.Exists(p => p.Contains(isbn));
        }
        ...
        {
            Libros.RemoveAll(l => l.Autor == autor);
        }

        public TituloAutor AutorTitulo(string isbn)
        {
            Libro l = Libros.Find(l => l.ISBN == isbn);
            return l != null ? new TituloAutor(l.Titulo, l.Autor) : null;
        }
    }
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Ejercicio 1. Extensión Biblioteca\n");
